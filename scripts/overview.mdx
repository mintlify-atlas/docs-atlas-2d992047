---
title: "HelloGitHub Automation Scripts: Content & Bot Tools"
sidebarTitle: "Overview"
description: "Explore the two Python automation scripts that power HelloGitHub: make_content.py for issue generation and github_bot.py for project discovery."
---
