...
description: "HelloGitHub Issue #121 — browse the curated open-source projects featured in the April 2025 monthly issue on GitHub."
---
...
<CardGroup cols={2}>
  <Card title="← Previous: Issue #120" icon="arrow-left" href="/issues/issue-120">
    March 2025 — printf-tac-toe, MonoGame, mujoco, dolt, openrocket, and more.
  </Card>
